    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(HttpMethod.POST, "/register").authenticated()
                .requestMatchers(HttpMethod.PUT, "/resolve/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/resolve/**").authenticated()
